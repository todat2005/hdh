...
/* Implement INCLUDE and OVERLAP checking mechanism
 * Interval convention: ranges are [start, end) (end is exclusive).
 */
#define INCLUDE(x1,x2,y1,y2) (((x1) <= (y1)) && ((y2) <= (x2)))
/* Two ranges [x1,x2) and [y1,y2) overlap when x1 < y2 && x2 > y1 */
